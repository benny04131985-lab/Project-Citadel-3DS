...
# it as wrapper_3DS_save_keyboard_V1.c.
...
def main() -> None:
    ...
    marker = "PROJECT CITADEL SAVE KEYBOARD V1"
    if marker in text:
        fail("This wrapper.c already contains the V1 save-keyboard patch.")

    include_anchor = '#include "newmfd.h"\n'
    include_block = '''#if defined(__3DS__) || defined(_3DS)
#include <3ds/applets/swkbd.h>
#warning "PROJECT CITADEL SAVE KEYBOARD V1: native save titles are ACTIVE"
#endif
...
'''
    ...
    output = source.with_name("wrapper_3DS_save_keyboard_V1.c")
