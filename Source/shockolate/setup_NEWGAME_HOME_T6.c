...
void go_and_start_the_game_already(void) {
    ...
    /*
     * PROJECT CITADEL T6:
     * Arm the normalizer only after the original New Game path has completed
     * every quest-variable, version, HUD, and setup-state assignment.
     * Continue/Load Game paths are intentionally untouched.
     */
    citadel_3ds_arm_newgame_home_t6();
#endif
}
