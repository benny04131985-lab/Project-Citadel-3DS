...
static bool citadel_gpu_initialize(void)
{
    ...
    v5_log("GPU V14Z DIAGNOSTIC ready texture=%dx%d content=%dx%d "
...
static void v5_log(const char *fmt, ...)
{
    FILE *file = fopen("GPU_C2D_V14Z.log", "a");
    va_list args;
...
void InitSDL() {
    ...
    remove("GPU_C2D_V14Z.log");
    v5_log("PROJECT CITADEL V14Z GPU TILE LIE DETECTOR START | build=%s %s", __DATE__, __TIME__);
