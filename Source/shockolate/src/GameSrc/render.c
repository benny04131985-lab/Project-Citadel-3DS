...
/*
 * Shock keydefs.h is force-included and defines KEY_UP, KEY_DOWN,
 * KEY_LEFT and KEY_RIGHT. libctru uses the same names in HID enums.
 * Hide the legacy macros while parsing the 3DS headers.
 */
