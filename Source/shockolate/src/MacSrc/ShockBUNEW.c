...
#warning "PROJECT CITADEL V12B: first native System Shock SFX is ACTIVE"
...
static void v5_log(const char *fmt, ...)
{
    FILE *file = fopen("SDL_SPLIT_V12B.log", "a");
    va_list args;
...
void InitSDL() {
    ...
    remove("SDL_SPLIT_V12B.log");
    v5_log("PROJECT CITADEL V12B START | build=%s %s", __DATE__, __TIME__);
