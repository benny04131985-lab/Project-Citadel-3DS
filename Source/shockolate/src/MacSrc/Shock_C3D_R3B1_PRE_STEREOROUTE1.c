...
/* -------------------------------------------------------------------------
 * PROJECT CITADEL C3D R3A2 WORLDSPACE SOLIDROOM1
 *
...
static void citadel_native_worldproof_write_start(void)
{
    ...
    fprintf(file,
            "============================================================\n"
            "PROJECT CITADEL C3D R3A2 WORLDSPACE SOLIDROOM1 ACTIVE\n"
            "============================================================\n"
            "Build: %s %s\n"
            "Mode: WORLDSPACE_TERRAIN_MIRROR\n"
            ...
            "Excluded: GENERIC_TMAP BITMAP HUD OBJECT SOLID FOG\n"
...
static void citadel_native_worldproof_write_summary(void)
{
    ...
    fprintf(file,
            "\n==================== SESSION SUMMARY =======================\n"
            "Milestone: CITADEL-C3D-R3A2-WORLDSPACE-SOLIDROOM1\n"
            "Mode: WORLDSPACE_TERRAIN_MIRROR\n"
            "Shader ready: %s\n"
            "Software polygon suppression: NO\n"
    ...
    float destination_h)
{
    ...
    if (!citadel_native_worldproof_first_draw_logged) {
        v5_log("GPU C3D R3A2 WORLDSPACE FIRST DRAW "
        ...
        citadel_native_worldproof_first_draw_logged = true;
    }
...
static bool citadel_gpu_initialize(void)
{
    ...
    v5_log("GPU C3D R3A2 WORLDSPACE SOLIDROOM1 ACTIVE "
           "mode=WORLDSPACE_TERRAIN_MIRROR "
