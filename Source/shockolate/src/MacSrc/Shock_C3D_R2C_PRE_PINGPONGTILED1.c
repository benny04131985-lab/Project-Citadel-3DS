...
static C3D_Tex citadel_gpu_cropped_top_left_texture;
static C3D_Tex citadel_gpu_cropped_top_right_texture;
static C3D_Tex citadel_gpu_cropped_bottom_texture;
...
#define CITADEL_C3D_PROFILE_LOG_PATH \
    "sdmc:/3ds/SystemShock3D/C3D_R2B_CROPPEDTILEDPROFILE.log"
...
static bool citadel_gpu_upload_surface(SDL_Surface *surface)
{
    ...
    if (!citadel_gpu_first_upload_logged) {
        v5_log("GPU V16.1 FIRST LIVE FEED src=%dx%d pitch=%d "
               ...
               "transport=CROPPED_TILED_OUTPUT_SIZED "
...
void InitSDL() {
    ...
    v5_log("PROJECT CITADEL C3D R2B CROPPEDTILED1 ACTIVE | "
