    ...
    const citadel_c3d_profile_bucket *bucket)
{
    ...
    v5_log("GPU C3D R1 PROFILE mode=%s "
           "avg_palette_ms=%0.3f avg_left_build_ms=%0.3f "
           "avg_left_swizzle_ms=%0.3f avg_right_acquire_ms=%0.3f "
           "avg_right_build_ms=%0.3f avg_right_swizzle_ms=%0.3f",
           mode,
           citadel_c3d_profile_average_ms(
...
#define CITADEL_C3D_PROFILE_LOG_PATH \
    "sdmc:/3ds/SystemShock3D/C3D_R1_TRANSPORTPROFILE.log"
    ...
    const citadel_c3d_profile_bucket *bucket)
{
    ...
    fprintf(file,
            "PROFILE mode=%s "
            "avg_palette_ms=%0.3f "
            "avg_left_build_ms=%0.3f "
            "avg_left_swizzle_ms=%0.3f "
            "avg_right_acquire_ms=%0.3f "
            "avg_right_build_ms=%0.3f "
            "avg_right_swizzle_ms=%0.3f\n",
            mode,
            citadel_c3d_profile_average_ms(
                bucket->palette_ticks, bucket->frames),
            citadel_c3d_profile_average_ms(
...
static void citadel_c3d_profile_write_startup_file(void)
{
    ...
    fprintf(file,
            "============================================================\n");
    fprintf(file,
            "PROJECT CITADEL C3D R1B PROFILELOCK1 ACTIVE\n");
    fprintf(file,
            "============================================================\n");
...
void InitSDL() {
    ...
    v5_log("PROJECT CITADEL C3D R1B PROFILELOCK1 ACTIVE | "
